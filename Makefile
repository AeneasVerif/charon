...
generate-rust-toolchain: \
	...
	generate-rust-toolchain-betree

.PHONY: generate-rust-toolchain-%
generate-rust-toolchain-charon: DIR := charon
generate-rust-toolchain-betree: DIR := tests/src/betree
generate-rust-toolchain-%:
	rm -f $(DIR)/rust-toolchain
	echo "# This file was automatically generated: if you need to perform modifications," >> $(DIR)/rust-toolchain
