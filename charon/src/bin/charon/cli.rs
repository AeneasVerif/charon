...
pub enum Charon {
    ...
    Rustc(RustcArgs),
    /// Runs charon on a cargo project. If a `Charon.toml` file is present at the project root,
    /// options are also read from it (CLI options take precedence). Run `charon cargo --help` for
